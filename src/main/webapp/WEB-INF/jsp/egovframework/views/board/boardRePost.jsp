...
<body>
	...
	<div class="container-fluid px-4">
		...
		<div class="card mb-4">
			<div class="card-body">
				<form method="post" id="boardRePost" action="/board/boardRePostProc.do">
				...
				<div class="mb-3 addSelect">
							...
							<select id="code_id" name="code_id" class="form-control code">
										<option class="code_select" value="null">대분류 선택 안 함</option>
			...
			success: function(data) {
				...
				if(data.length != 0) {
					...
					str += '<select id="code_mid_id" name="code_mid_id" class="form-control code_mid">'
						str += '<option class="code_mid_select" value="null">중분류 선택</option>'
			...
			success: function(data) {
				...
				if(data.length != 0) {
					...
					str += '<select id="code_sub_id" name="code_sub_id" class="form-control code_sub">'
						str += '<option class="code_sub_select" value="null">소분류 선택</option>'
					$.each(data, function(idx, value) {
